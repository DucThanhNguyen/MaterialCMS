...
{
    public class MediaCategoryController : MaterialCMSAdminController
    {
        ...
        [MaterialCMSACLRule(typeof(MediaToolsACL), MediaToolsACL.Cut)]
        ...
        [MaterialCMSACLRule(typeof(MediaToolsACL), MediaToolsACL.Delete)]
