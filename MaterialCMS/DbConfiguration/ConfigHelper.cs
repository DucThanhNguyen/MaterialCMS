...
namespace MaterialCMS.DbConfiguration
{
    public static class ConfigHelper
    {
        ...
        {
            foreach (Type baseType in TypeHelper.GetAllConcreteTypesAssignableFrom<MaterialCMSApp>()
                .Select(type => Activator.CreateInstance(type) as MaterialCMSApp)
        ...
        {
            foreach (var baseType in TypeHelper.GetAllConcreteTypesAssignableFrom<MaterialCMSApp>()
                                        .Select(type => Activator.CreateInstance(type) as MaterialCMSApp)
