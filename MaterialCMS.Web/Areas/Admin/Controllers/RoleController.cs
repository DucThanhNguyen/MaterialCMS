...
{
    public class RoleController : MaterialCMSAdminController
    {
        ...
        [MaterialCMSACLRule(typeof(RoleACL), RoleACL.View)]
        ...
        [HttpGet]
        [MaterialCMSACLRule(typeof(RoleACL), RoleACL.Add)]
        ...
        [HttpGet]
        [ActionName("Edit")]
        [MaterialCMSACLRule(typeof(RoleACL), RoleACL.Edit)]
        ...
        [HttpGet]
        [ActionName("Delete")]
        [MaterialCMSACLRule(typeof(RoleACL), RoleACL.Delete)]
