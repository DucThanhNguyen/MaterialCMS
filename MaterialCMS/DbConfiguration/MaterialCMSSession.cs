...
{
    public class MaterialCMSSession : ISession
    {
        ...
        public MaterialCMSSession(ISession session, HttpContextBase httpContext)
        {
            _session = session;
        ...
        {
            return new MaterialCMSTransaction(_session.BeginTransaction(), this);
        }
