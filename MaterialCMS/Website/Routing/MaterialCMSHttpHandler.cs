...
{
    public sealed class MaterialCMSHttpHandler : IHttpHandler, IRequiresSessionState
    {
        private readonly IMaterialCMSRoutingErrorHandler _errorHandler;
        private readonly List<IMaterialCMSRouteHandler> _routeHandlers;

        public MaterialCMSHttpHandler(IEnumerable<IMaterialCMSRouteHandler> routeHandlers, IMaterialCMSRoutingErrorHandler errorHandler)
        {
        ...
        {
            context.HttpContext.Response.AppendHeader("X-Built-With", "Material CMS - http://www.materialcms.com");
        }
