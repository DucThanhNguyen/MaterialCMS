...
namespace MaterialCMS.Indexing.Management
{
    public abstract class FieldDefinition
    {
        ...
        {
            IEnumerable<IFieldDefinitionInfo> fieldDefinitionInfos = MaterialCMSApplication.GetAll<IFieldDefinitionInfo>();
        ...
        {
            var fieldName = MaterialCMSApplication.Get(TypeHelper.GetTypeByName(definitionTypeName)) as IFieldDefinitionInfo;
