...
(function ($) {
    var materialcmsOpenMenuItems = "materialcms-open-menu-items";
    function storeOpenTabs() {
        var data = $("li[data-menu].open").map(function () {
            return $(this).data('menu');
        }).get().join(",");
        store.set(materialcmsOpenMenuItems, data);
    }
    function openNavItems() {
        var items = store.get(materialcmsOpenMenuItems) || '';
    ...
    $(document).ready(function () {
        $('li[data-menu] > [data-toggle=dropdown-materialcms]').on('click', function (event) {
