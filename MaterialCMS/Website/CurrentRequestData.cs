...
namespace MaterialCMS.Website
{
    public class CurrentRequestData
    {
        ...
        public static Site CurrentSite
        {
            get
            {
                return (Site) CurrentContext.Items["current.site"] ??
                       (CurrentSite = MaterialCMSApplication.Get<ICurrentSiteLocator>().GetCurrentSite());
            }
            set
            {
        ...
        {
            get { return MaterialCMSApplication.Get<HttpContextBase>(); }
        }
        ...
        public static bool DatabaseIsInstalled
        {
            get
            {
                ...
                {
                    return MaterialCMSApplication.Get<IEnsureDatabaseIsInstalled>().IsInstalled();
                }
        ...
        {
            var session = MaterialCMSApplication.Get<ISession>();
            if (value != null)
            {
