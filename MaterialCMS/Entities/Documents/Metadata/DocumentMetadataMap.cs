...
namespace MaterialCMS.Entities.Documents.Metadata
{
    /// <summary>
    /// Abstract class useed to define metadata of your documents within Material CMS
    /// </summary>
    ...
    {
        /// <summary>
        /// Name of the document type for display when adding a page in Material CMS. I.E Text Page, Blog Page etc
        /// </summary>
        public virtual string Name { get { return typeof(T).Name.BreakUpString(); } }

        /// <summary>
        /// The icon shown next to the page type in Material CMS admin. By default icons are taken from bootstrap
        /// </summary>
        ...
        /// </summary>
        public virtual string App { get { return MaterialCMS.Apps.MaterialCMSApp.AppWebpages.ContainsKey(typeof(T)) ? MaterialCMS.Apps.MaterialCMSApp.AppWebpages[typeof(T)] : null; } }
