...
namespace MaterialCMS.ACL
{
    public abstract class ACLRule
    {
        ...
        protected virtual MaterialCMSApp App { get { return null; } }
    ...
    public abstract class ACLRule<T> : ACLRule where T : MaterialCMSApp, new()
    {
        protected override MaterialCMSApp App { get { return new T(); } }
    }
}