...
{
    public class WebpageController : MaterialCMSAdminController
    {
        ...
        [HttpGet, ActionName("Edit"), MaterialCMSTypeACL(typeof(Webpage), TypeACLRule.Edit)]
        ...
        [HttpPost, MaterialCMSTypeACL(typeof(Webpage), TypeACLRule.Edit), ForceImmediateLuceneUpdate]
        ...
        [HttpGet, MaterialCMSTypeACL(typeof(Webpage), TypeACLRule.Delete), ActionName("Delete")]
        public virtual ActionResult Delete_Get(Webpage document)
        {
            return PartialView(document);
        }

        [HttpPost, MaterialCMSTypeACL(typeof(Webpage), TypeACLRule.Delete), ForceImmediateLuceneUpdate]
