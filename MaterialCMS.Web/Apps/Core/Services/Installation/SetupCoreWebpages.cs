    ...
    public class SetupCoreWebpages : ISetupCoreWebpages
    {
        ...
        private IEnumerable<Webpage> GetBasicPages()
        {
            var homePage = new TextPage
            {
                ...
                UrlSegment = "home",
                BodyContent =
                    "<h1>Material CMS</h1> <p>Welcome to Material CMS, the only CMS you will need.</p><p> Turn on inline editing above, then click here. Pretty cool huh? </p>",
            ...
            var contactUs = new TextPage
            {
                ...
                BodyContent = "<h1>Contact</h1>Contact us at http://materialcms.net. <p>Test form</a> [form]",
                RevealInNavigation = true,
            };
