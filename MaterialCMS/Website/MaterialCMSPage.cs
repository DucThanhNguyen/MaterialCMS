...
{
    public abstract class MaterialCMSPage<TModel> : WebViewPage<TModel>
    {
        ...
        public override void InitHelpers()
        {
            ...
            {
                _kernel = MaterialCMSApplication.Get<IKernel>();
                _stringResourceProvider = MaterialCMSApplication.Get<IStringResourceProvider>();
                GetCurrentLayout = MaterialCMSApplication.Get<IGetCurrentLayout>();
            }
        }
    ...
    public abstract class MaterialCMSPage : MaterialCMSPage<dynamic>
    {
    }
}