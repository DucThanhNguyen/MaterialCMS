...
namespace MaterialCMS.Services.ImportExport
{
    public class ExportDocumentsService : IExportDocumentsService
    {
        ...
        private static void CreateInfoSheet(ExcelPackage excelFile)
        {
            ...
            wsInfo.Cells["D2"].Value = string.Format("MaterialCMS {0}", MaterialCMSApplication.AssemblyVersion);
