...
namespace MaterialCMS.Apps
{
    public abstract class MaterialCMSApp
    {
        protected abstract void RegisterApp(MaterialCMSAppRegistrationContext context);
        ...
        public static bool CheckIsInApp(Type type, MaterialCMSApp app)
        {
        ...
        private static List<MaterialCMSApp> _allApps;
        ...
        {
            var context = new MaterialCMSAppRegistrationContext(this.AppName, routes, state);
        ...
        private static List<MaterialCMSApp> AllApps
        {
            get
            {
                return _allApps = _allApps ?? TypeHelper.GetAllConcreteTypesAssignableFrom<MaterialCMSApp>()
                                                        .Select(type => ((MaterialCMSApp)Activator.CreateInstance(type))).ToList();
            }
        }
