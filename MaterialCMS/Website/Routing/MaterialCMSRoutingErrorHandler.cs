...
{
    public class MaterialCMSRoutingErrorHandler : IMaterialCMSRoutingErrorHandler
    {
        private readonly IGetErrorPage _getErrorPage;
        private readonly IControllerManager _controllerManager;
        private readonly SiteSettings _siteSettings;

        public MaterialCMSRoutingErrorHandler(IGetErrorPage getErrorPage, IControllerManager controllerManager, SiteSettings siteSettings)
        {
